    ...
    return (<div style={{ padding: "var(--space-6)", maxWidth: 1200 }}>
        ...
        <div className="card" style={{ overflow: "hidden" }}>
            <div style={{ padding: "var(--space-3) var(--space-4)", background: "var(--color-bg-secondary)", borderBottom: "1px solid var(--color-border)", display: "flex", alignItems: "center", gap: "var(--space-2)" }}>
                ...
                <input type="text" placeholder="Search logs..." style={{ border: "none", background: "transparent", outline: "none", width: "100%", fontSize: "14px", color: "var(--color-text-primary)" }} />
            </div>
                ...
                <tbody>
                    {logs.map(l => (
                        <tr key={l.id} style={{ borderBottom: "1px solid var(--color-border)" }}>
                            ...
                            <td style={{ padding: "12px 16px", fontWeight: 500 }}><span className="badge badge-neutral">{l.user}</span></td>
